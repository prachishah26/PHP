        ...
        <div class="row">
            ...
            <div class="col-8 right-panel">
                ...
                <div class="buttons ">
                    ...
                    <button class="btn btn-light back" data-path='/home/woc/Prachi/Training/PHP/Web_file_explorer_1'><i class="fa fa-arrow-circle-left" aria-hidden="true"></i>
                        BACK</button>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <p class="error text-danger" style='height:20px;'></p>
                                <br />
                ...
                <div id="renameModal" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title"><span id="change_title">Rename</span></h4>
                            </div>
                            <div class="modal-body">
                                <p>Enter new Name
                                ...
                                <input type="hidden" name="action" id="action" />
                                <input type="hidden" name="old_name" id="old_name" />
                                <input type="button" name="new_button" id="new_button" class="btn btn-info"
                                    value="Create" />
